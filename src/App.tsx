...
export type FilterValuesType = "all" | "active" | "completed" | "theFirstThree";
...
function App() {
    ...
    if (filter === "theFirstThree") {
        tasksForTodolist = []
        if (tasks.length >= 3){
            tasksForTodolist.push(tasks[0])
            tasksForTodolist.push(tasks[1])
            tasksForTodolist.push(tasks[2])
        } else {
